...
def get_parser():
    ...
    parser.add_argument('--seed', type=int, default=4019585660)
    parser.add_argument('--nhid', type=int, default=64)
    parser.add_argument('--dataset', type=str, default='BlogCatalog',
              choices=['cora','BlogCatalog','citeseer'])
    ...
    parser.add_argument('--setting', type=str, default='recon', 
        choices=['no','upsampling', 'reweight','embed_up', 'recon','newG_cls','recon_newG'])
    ...
    parser.add_argument('--rec_weight', type=float, default=1e-6)
...
def recon_upsample(embed, labels, idx_train, adj=None, portion=1.0, im_class_num=3):
    ...
    for i in range(im_class_num):
        ...
        if chosen.shape[0] == 0:
          print("Chosen is empty. Skipping iteration.")
          continue
